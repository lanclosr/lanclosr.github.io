...
(function(){
    ...
    // global variables
    var attrArray = ["DamageStructures", "Households", "TotalPopulation"];
    ...
    function setMap(){    
        ...
        //create and add dropdown menu to change attributes
   ...
   //function to validate all attributes in the colorscale!
    ...
    function setChart(csvData, colorScale){
        ...
        var xAxis = d3.axisBottom()
            .scale(chartInnerWidth / csvData.length - 1)
    ...
    //function create dropdown menu for attribute selection
    ...
    //function to change the handler
    ...
    function updateChart(bars, n, colorScale){
        ...
        .text(expressed + " in each watershed");
    };
})();